...
function(error, record, search , dialog, message, utilities) {
    ...
    function saveRecord(scriptContext) {
     try{
      log.audit('Inicio Grabar Configuracion Cupones','Submit - Tipo : Configuracion Cupones');
   ...
   var resultSet = mySearch.run();
       ...
       alert('Solo puede cargar una configuraci' + '\u00f3' + 'n de Cupones. Verifique.');
       return false;
      }
     ...
     log.error('Grabar Configuracion Cupones','Submit - Excepcion Grabando Configuracion Cupones - Excepcion : ' + excepcion.message);
    }
    log.audit('Fin Grabar Configuracion Cupones','Submit - Tipo : Configuracion Cupones');
    return true;
    }
